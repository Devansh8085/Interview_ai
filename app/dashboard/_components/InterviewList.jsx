...
const InterviewList = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-4 bg-gradient-to-br from-white to-teal-50">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center space-y-6 p-12 bg-white rounded-xl shadow-md">
          ...
          <button className="px-6 py-3 bg-gradient-to-r from-teal-500 to-teal-700 text-white rounded-full shadow-lg hover:scale-105 transition-transform">
